      ...
      >
        ...
        <Grid
          ...
          areas={[
            ...
            { name: "middleLayout10", start: [0, 1], end: [0, 1] },
          ]}
        >
          <Box
            gridArea="middleLayout00"
            background="unset"
            flex={false}
            direction="column"
          >
            {quiz.questions.map((question) => this.renderQuestion(question))}
          </Box>
          <Box
            gridArea="middleLayout10"
            background="unset"
            flex={false}
            direction="column"
          >
